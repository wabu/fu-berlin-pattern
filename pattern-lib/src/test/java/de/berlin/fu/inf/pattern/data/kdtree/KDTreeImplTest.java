...
public class KDTreeImplTest {
	private KDTreeImpl<Vector> kdTree;
	private List<Vector> values;
	
	@Before
	public void setUp() throws Exception {
		
		kdTree = new KDTreeImpl<Vector>(3);
		
		values = new ArrayList<Vector>(5);
		
		values.add(new Vector(new int[]{3,3,3}));
		values.add(new Vector(new int[]{1,2,2}));
		values.add(new Vector(new int[]{5,1,5}));
		values.add(new Vector(new int[]{4,4,1}));
		values.add(new Vector(new int[]{2,7,4}));
	...
	public void buildTreeTest() {
		kdTree.buildTree(values.toArray(new Vector[0]));
		
		Node<Vector> root = kdTree.getRootNode();
	...
	public void findNeighbour() {
		...
		assertEquals(
				new Vector(new int[]{5,1,5}),
				kdTree.findNearestValues(new Vector(new int[]{6,1,5})));
		assertEquals(
				new Vector(new int[]{3,3,3}),
				kdTree.findNearestValues(new Vector(new int[]{4,4,4})));
		assertEquals(
				new Vector(new int[]{3,3,3}),
				kdTree.findNearestValues(new Vector(new int[]{3,4,3})));
		assertEquals(
				new Vector(new int[]{1,2,2}),
				kdTree.findNearestValues(new Vector(new int[]{2,2,2})));
		assertEquals(
				new Vector(new int[]{3,3,3}),
				kdTree.findNearestValues(new Vector(new int[]{3,2,2})));
	}
}
