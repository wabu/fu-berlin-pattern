...
public class DoubleVector
        implements Dimensionable<DoubleVector>, Vectorable, Messurable<DoubleVector> {
    ...
    public int compareInDimension(DoubleVector dimObject, int dimension) {
        return this.getValueInDimension(dimension) < dimObject.
                getValueInDimension(dimension) ? -1
                : this.getValueInDimension(dimension) > dimObject.
                getValueInDimension(dimension) ? 1 : 0;
    }

    public double getDistanceInDimension(DoubleVector dimObject, int dimension) {
        return Math.abs(getValueInDimension(dimension) - dimObject.
                getValueInDimension(dimension));
    }
